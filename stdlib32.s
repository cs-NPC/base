...
printf:
    ...
    xor edi,edi        ; args[ptr push byte %s, direct push:%x,%d,%c]
...
fopen: ;file descriptor is in [fd] buffer
    push ebp
    push eax
    mov ebp,esp
    mov ebx,[ebp+8]
...
section .data
    ermsg  db 'file directory invalid for fopen',endl
    ermsg2 db 'File need to be opened first',endl
    ;fd     dd 0